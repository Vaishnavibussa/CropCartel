    <?php
        session_start();
    ?>
    <!-- <?php echo isset($_SESSION['Section']) ? $_SESSION['Section'] : ''; ?> -->
        ...
        <section id="post" class="wrapper bg-img" data-bg="banner2.jpg">
            <div class="inner">
                ...
                <header>
                    ...
                    <img src="images/profileImages/<?php echo isset($_SESSION['picName']) ? $_SESSION['picName'] : 'default.jpg'; ?>" class="img-circle" class="img-responsive" height="200px">
                    <br>
