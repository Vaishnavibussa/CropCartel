	...
	<body>
		...
		<!-- One -->
			...
			<section id="one" class="wrapper style1 align-center">
				...
				<div class="row">
					  <div class="col-sm-6">
						  <div class="select-wrapper" style="width: auto;margin-bottom:8px; "  >
							  <select name="type" id="type" required style="background-color:white;color: black;">
								  <option value="" style="color: black; font-weight:bold;">- Category -</option>
								  <option value="Fruit" style="color: black; font-weight:bold;">Fruit</option>
								  <option value="Vegetable" style="color: black; font-weight:bold;">Vegetable</option>
								  <option value="Grains" style="color: black; font-weight:bold;">Grains</option>
							  </select>
						</div>
					  </div>
					  <div class="col-sm-6">
						<input type="text" name="pname" font-weight="bold" id="pname" value="" placeholder="Product Name" style=" background-color:white;font-weight=bold margin-bottom=20px;	color: black;" />
					  </div>
				</div>
				<br>
				<div>
			...
			<div class="row">
				<div class="col-sm-6">
					  <input type="text" name="price" id="price" value="" placeholder="Price" style="background-color:white; font-weight:bold; color: black;" />
				</div>
				<div class="col-sm-6">
					<button class="button fit" style="width:auto; color:black; font-weight=bolder; margin-top:8px; font-size=8px">Submit</button>
				</div>
			</div>
			</form>
		</div>
