	...
	?>
		...
		<!-- Banner -->
			...
			<section id="banner" class="wrapper">
				<div class="container">
				<h2>CropCartel</h2>
				<p>Fresh from the Fields, Straight to You</p>
				<p>Cutting Out Middlemen and Empowering Farmers!</p>
				<br><br>
				<center>
		...
		<!-- Footer -->
		<footer class="footer-distributed" style="background-color:ash
		" id="aboutUs">
		<center>
			<h1 style="font: 35px calibri;">About Us</h1>
		</center>
		<div class="footer-left">
			<h3 style="font-family: 'Times New Roman', cursive;">CropCartel &copy; </h3>
		<!--	<div class="logo">
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">CropCartel Fam<span>Hyderabad</span></p>
			</div>
			<div>
				<i class="fa fa-phone"></i>
				<p style="font-size:20px">9898767654</p>
			</div>
			<div>
				<i class="fa fa-envelope"></i>
				<p style="font-size:20px"><a href="mailto:cropcartel@gmail.com" style="color:white">cropcartel@gmail.com</a></p>
			</div>
		</div>

		<div class="footer-right">
			<p class="footer-company-about" style="color:white">
				<span style="font-size:20px"><b>About CropCartel</b></span>
				CropCartel is e-commerce trading platform for grains & grocerries...
			</p>
